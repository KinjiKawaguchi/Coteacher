...
func (fq *FormQuery) QueryClass() *ClassQuery {
	query := (&ClassClient{config: fq.config}).Query()
...
func (fq *FormQuery) FirstID(ctx context.Context) (id uuid.UUID, err error) {
	var ids []uuid.UUID
...
func (fq *FormQuery) FirstIDX(ctx context.Context) uuid.UUID {
...
func (fq *FormQuery) OnlyID(ctx context.Context) (id uuid.UUID, err error) {
	var ids []uuid.UUID
...
func (fq *FormQuery) OnlyIDX(ctx context.Context) uuid.UUID {
...
func (fq *FormQuery) IDs(ctx context.Context) (ids []uuid.UUID, err error) {
...
func (fq *FormQuery) IDsX(ctx context.Context) []uuid.UUID {
	ids, err := fq.IDs(ctx)
	if err != nil {
		panic(err)
	}
...
func (fq *FormQuery) WithClass(opts ...func(*ClassQuery)) *FormQuery {
	query := (&ClassClient{config: fq.config}).Query()
...
func (fq *FormQuery) sqlAll(ctx context.Context, hooks ...queryHook) ([]*Form, error) {
	...
	if query := fq.withClass; query != nil {
		if err := fq.loadClass(ctx, query, nodes, nil,
			func(n *Form, e *Class) { n.Edges.Class = e }); err != nil {
			return nil, err
		}
	}
...
func (fq *FormQuery) loadClass(ctx context.Context, query *ClassQuery, nodes []*Form, init func(*Form), assign func(*Form, *Class)) error {
...
func (fq *FormQuery) loadQuestions(ctx context.Context, query *QuestionQuery, nodes []*Form, init func(*Form), assign func(*Form, *Question)) error {
	...
	if len(query.ctx.Fields) > 0 {
		query.ctx.AppendFieldOnce(question.FieldFormID)
	}
...
func (fq *FormQuery) loadResponses(ctx context.Context, query *ResponseQuery, nodes []*Form, init func(*Form), assign func(*Form, *Response)) error {
	...
	if len(query.ctx.Fields) > 0 {
		query.ctx.AppendFieldOnce(response.FieldFormID)
	}
...
func (fq *FormQuery) querySpec() *sqlgraph.QuerySpec {
	_spec := sqlgraph.NewQuerySpec(form.Table, form.Columns, sqlgraph.NewFieldSpec(form.FieldID, field.TypeUUID))
	_spec.From = fq.sql
	...
	if fields := fq.ctx.Fields; len(fields) > 0 {
		...
		if fq.withClass != nil {
			_spec.Node.AddColumnOnce(form.FieldClassID)
		}
	}
